...
/* Ogni carceriere combatte a modo suo. Le otto zone avevano colori e nomi
   ...
   giro       : sovrascrive DUELLO.giro — l'anello si chiude più in fretta
   pausaDa/A  : pausa casuale fra un anello e l'altro — niente ritmo da imparare
   svanisce   : l'anello diventa invisibile a questa frazione del percorso,
                e il bersaglio non si accende: si conta
   doppio     : un secondo anello nasce tot secondi dopo il primo; ciascuno
                vale `peso` di un colpo normale, altrimenti due anelli per
                giro sarebbero un regalo
   finta      : probabilità che un anello sia rosso — toccarlo ridà vita al
                carceriere
   salto      : di quanti pixel si può spostare il bersaglio da un anello
                all'altro
