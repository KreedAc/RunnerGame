...
SRC="web/src/i18n.js web/src/core.js web/src/art.js web/src/world.js web/src/fx.js web/src/actors.js web/src/hub.js web/src/imprese.js web/src/trappole.js web/src/game.js"
